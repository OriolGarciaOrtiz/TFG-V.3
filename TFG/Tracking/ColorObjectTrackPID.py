...
# --- NUEVO: Variables PID ---
Kp = 0.4   # Ganancia proporcional #Kp: cuánto corrige según el error actual.
Ki = 0.0005 # Ganancia integral #Ki: cuánto acumula errores pasados.
Kd = 0.3   # Ganancia derivativa #Kd: cuánto anticipa el cambio (suaviza).
...
while True:
    ...
    if object_center is not None:
        ...
        # --- elegir modo ---
        valor = 4  # 1=P, 2=I, 3=D, otro=PID completo
