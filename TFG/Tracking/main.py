    ...
    if is_connected:
        ...
        if object_center:
            ...
            if opt.get() == "P":
                ...
                speed_z = int(Ki_z.get() * derivative_z)
            elif opt.get() == "PID":
