...
from tkinter import messagebox, OptionMenu, Label, StringVar
...
class GUI:
    def __init__(self, root: tk.Tk, mode: str):
        ...
        try:
            file_path = r"TFG_Joel_Oriol\taller-dron-Tello\Lib\Parameters\parametros_camara_tello.npz"
    ...
    def create_hsv_sliders(self):
        ...
        self.bird_img = load_img("TFG_Joel_oriol/Fotos/bird.jpg")
        self.dog_img = load_img("TFG_Joel_oriol/Fotos/dog.jpg")
        self.cat_img = load_img("TFG_Joel_oriol/Fotos/cat.jpg")
